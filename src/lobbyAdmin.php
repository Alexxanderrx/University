    ...
    <body>
        <div class="bg-[#f1f3f5] h-screen w-screen flex">
            <section id="toggleMenu" class="h-full w-1/6 bg-[#30363b]">
                <div id="toggleMenuU" class="h-16 w-full border-b flex md:justify-start justify-center md:pl-4 items-center">
                ...
                <div id="CARGO" class="md:flex hidden h-28 w-full border-b flex-col justify-around items-start text-white p-4">
                    ...
                    <p class="truncate"><?php print_r($_SESSION["nombre"]); ?></p>
                </div>
                <div class="w-full flex flex-col justify-center items-center text-white">
                    ...
                    <button id="btnAlumnos" class="<?php print_r($_SESSION['pemision3']); ?> w-full flex md:justify-start justify-center items-center p-4 hover:bg-[#3d4449]">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            <div id="section01" class="flex flex-col w-5/6 justify-between items-center">
                <section class=" flex flex-col w-full h-full justify-start items-center">
                    <nav class="h-16 w-full bg-white flex md:justify-between justify-end items-center border">
                        ...
                        <ul id="toggle" class="flex flex-col justify-center items-center py-4  md:w-48 w-40 border rounded-b-xl bg-white absolute right-0 md:top-16 top-16 collapse">
                    ...
                    <div class="h-16 w-11/12  flex justify-between items-center">
                        ...
                        <p class="text-xs md:text-base"><span class=" text-sky-500">Home</span> / <span id="title02">Dashboard</span></p>
                    </div>
                ...
                <footer class="h-12 w-full md:text-base text-xs bg-white flex justify-between items-center border px-4 text-gray-500">
                    <p>Copyright © 2023 <a class="text-gray-700" href="https://github.com/Alexxanderrx" target="_blank">Alexxanderrx.</a>
                        All rights reserved.</p>
                    <p class="md:flex hidden">Anything you want</p>
                </footer>
            </div>
        </div>
    </body>
