        ...
        <div class="bg-[#f1f3f5] h-screen w-screen flex">
            <section id="toggleMenu" class="h-full w-1/5 bg-[#30363b]">
                ...
                <div class="w-full flex flex-col justify-center items-center text-white">
                    <p id="MENU_AD" class="p-4 md:flex hidden">MENU ADMINISTRACIÓN</p>
                    <div class="w-full flex md:justify-start justify-center items-center p-4 hover:bg-[#3d4449]">
            ...
            <section id="section01" class="flex flex-col w-4/5 h-full justify-start items-center">
                ...
                <div class="h-16 w-11/12  flex justify-between items-center">
                    <p class="text-xl md:text-2xl font-medium">Dashboard</p>
                    <p class="text-xs md:text-base"><span class=" text-sky-500">Home</span> / Dashboard</p>
                </div>
                <div class="flex w-11/12  justify-start items-start">
