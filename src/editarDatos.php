<card class="w-full h-full pb-4 bg-white border">
    ...
    ?>
    <form class="flex flex-col h-[80%] p-4 overflow-y-scroll" name="formularioEditar" method="post"
        action="./hallEditar.php">
        ...
        <input name="editEmail" class="border rounded-md p-2 mb-2" type="text" value="<?php print_r($email); ?>"
            required />
        ...
        <input name="editName" class="border rounded-md p-2 mb-2" type="text" value="<?php print_r($name); ?>"
            required />

        <b class="mb-2">Apellido(s)</b>
        <input name="editLastname" class="border rounded-md p-2 mb-2" type="text"
        ...
        <input name="editBirthday" class="border rounded-md p-2 py-6 mb-6" type="date"
            value="<?php print_r($birthday); ?>" />

        <button id="submitEdit"
            class="w-fit dark:bg-gray-500 dark:hover:bg-gray-700 bg-[#007aff] hover:bg-[#1d3e8f] text-white  py-2 px-4 rounded-lg"
